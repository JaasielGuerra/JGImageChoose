...
- Obtener la imagen seleccionada como:
    ...
    - ImageIcon
    - Ruta de la imagen
    - ***NOTA:*** *la imagen obtenida conservará las dimensionas exactas del archivo de origen*
...
Como primer paso deberá agregar el componente a su proyecto, vaya a las realeses del proyecto y descarge `JGImageChoose-1.0.0-Beta.jar` y agréguelo a su ruta de compilación, y listo!.

### Para usuarios de maven:
aca el pinchi repo XD
...
- Click sobre `add from JAR` y búsque el `JGImageChoose-1.0.0-Beta.jar` y selecciónelo. Luego click en `next`
